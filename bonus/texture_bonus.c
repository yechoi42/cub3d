...
/*   Updated: 2020/07/29 16:59:23 by yechoi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		load_texture(t_game *game)
{
	...
	game->config.tex[C_TUNA].texture =
		load_image(game, "./textures/tuna.xpm", &img, C_TUNA);
	game->config.tex[C_LB].texture =
		load_image(game, "./textures/lifebar.xpm", &img, C_LB);
	game->config.tex[C_GC].texture =
		load_image(game, "./textures/clear.xpm", &img, C_GC);
}
